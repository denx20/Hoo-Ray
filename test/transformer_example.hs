...
main = do
  ...
  let wq = generateRandomMatrix 512 64 0.1 654321
  let wk = generateRandomMatrix 512 64 0.1 132456
  let wv = generateRandomMatrix 512 512 0.1 612453

  let w1 = generateRandomMatrix 512 2048 1.0 230340
